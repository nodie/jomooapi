...
switch($opt){
    ...
    case "msfUploadWorker":
        ...
        $address->address_detail = $jsonStr['address_detail'];
        ...
        $address->address_names = preg_replace("/\//", ",", $jsonStr['address_names']);
        ...
        $service_areas->division_names = preg_replace("/\//", ",", $jsonStr['division_names']);
